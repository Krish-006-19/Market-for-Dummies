...
const CATEGORY_GROUPS = [
  {
    ...
    categories: ["Equity Scheme - Flexi Cap Fund"],
  },
  {
    key: "large-cap",
  ...
  },
  {
    ...
    categories: ["Equity Scheme - Mid Cap Fund"],
  },
  {
    key: "hybrid",
  ...
  },
  {
    ...
    categories: ["Other Scheme - Index Funds"],
  },
];
...
function Trade() {
  ...
  const groupedFunds = useMemo(() => {
    ...
    for (const group of CATEGORY_GROUPS) {
      map[group.key] = filteredFunds.filter((fund) =>
        group.categories.includes(fund.category)
      );
    }
